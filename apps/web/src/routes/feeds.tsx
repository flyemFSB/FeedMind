...
import { SourceManageDialog } from "@/components/feeds/source-manage-dialog";
...
/* ── Mock platform icons (simple color dots) ── */
...
function FeedsPage() {
  ...
  return (
    <LayoutWrapper title={t("feeds.title")} topRightContent={topRightContent}>
      ...
      <SourceManageDialog open={showSourceDialog} onClose={() => setShowSourceDialog(false)} />
    </LayoutWrapper>
  );
}
        ...
        {item.platform && (
          <span
            className={cn(
              ...
              PLATFORM_STYLES[item.platform]?.dot
