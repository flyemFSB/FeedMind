...
import { MoreHorizontal, Plus, Settings, LogOut } from "lucide-react";
...
export function Sidebar({ onSettingsClick, mobile = false }: SidebarProps) {
  ...
  const asideClassName = `flex h-full w-[260px] min-w-[260px] flex-col border-r border-[#d2d2d7] bg-white ${
