    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <h3 className="text-[15px] font-semibold text-editorial-ink">{t("settings.system")}</h3>
      ...
      <div className="flex items-center justify-between rounded-xl border border-editorial-hairline px-5 py-4">
        ...
        <Select value={currentLang} onValueChange={handleLanguageChange}>
          <SelectTrigger
            ...
            className="h-9 w-[150px] rounded-xl border-editorial-hairline bg-editorial-surface-card px-3 text-[12px] text-editorial-ink hover:bg-editorial-surface-soft"
          >
      ...
      <div className="flex items-center justify-between rounded-xl border border-editorial-hairline px-5 py-4">
        <div className="min-w-0">
          ...
          <p className="mt-0.5 text-[11px] text-editorial-ink-muted">{t("settings.theme")}</p>
        </div>
