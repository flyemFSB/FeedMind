  ...
  ignore: {
    overrides: [
      ...
      },
      {
        ...
        files: ["src/components/remote-connection/feishu-config-panel.tsx"],
      ...
      },
      {
        ...
        files: ["src/components/daily-report/video-player-dialog.tsx"],
      ...
      },
      {
        ...
        files: ["src/components/daily-report/schedule-card.tsx"],
